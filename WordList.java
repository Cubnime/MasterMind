...
public final class WordList extends Object
{
    ...
    public boolean findWord(String s) {
        for (int i =0; i < numUsed ; i++ ) {
            if (this.words[i].getWord().equals(s)) {
                //System.out.println(" WordList: findWord - found " + s);
                return true;
            }
        }
        //System.out.println(" WordList: findWord - couldn't find " + s);
        return false;
    }
    ...
    public String[] findMatches(String s) {
        ...
        //System.out.println(" WordList: findMatches :");
        int l = s.length();
        for (int i = 0; i < this.numUsed; i++) {
            if (this.words[i].getWord().substring(0,l).equals(s)) {
                //System.out.println("  "+this.words[i].getWord());
                result.add(this.words[i].getWord());;
            }
        }
